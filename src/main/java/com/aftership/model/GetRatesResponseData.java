...
public class GetRatesResponseData extends Resource {
    ...
    private java.util.List<RateRecordV3> rates;
    ...
    public java.util.List<RateRecordV3>  getRates() {
        return rates;
    }

    public void setRates(java.util.List<RateRecordV3>  rates) {
        this.rates = rates;
    }
