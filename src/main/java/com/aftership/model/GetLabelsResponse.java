...
public class GetLabelsResponse extends Resource {

    private java.util.Map<String, java.util.List<String>> responseHeader;

    private GetLabelsResponseData data;
    ...
    public GetLabelsResponseData getData() {
        return data;
    }

    public void setData(GetLabelsResponseData data) {
        this.data = data;
    }
}
