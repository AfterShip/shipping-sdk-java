...
public class GetPickupsResponseData extends Resource {
    ...
    private java.util.List<PickupV3> pickups;
    ...
    public java.util.List<PickupV3>  getPickups() {
        return pickups;
    }

    public void setPickups(java.util.List<PickupV3>  pickups) {
