...
public class GetCancelLabelsResponse extends Resource {

    private java.util.Map<String, java.util.List<String>> responseHeader;

    private GetCancelLabelsResponseData data;
    ...
    public GetCancelLabelsResponseData getData() {
        return data;
    }

    public void setData(GetCancelLabelsResponseData data) {
        this.data = data;
    }
}
