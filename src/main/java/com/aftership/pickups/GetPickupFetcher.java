...
import com.aftership.model.GetPickupResponse;
import com.aftership.model.PickupV3;

public class GetPickupFetcher extends Fetcher<GetPickupResponse> {
    private final Map<String, String> headerParams= new HashMap<>(8);

    public GetPickupFetcher addHeaderParam(final String name, final String value) {
    ...
    public GetPickupFetcher setId(String id) {
        this.id = id;
        return this;
    }

    @Override
    public GetPickupResponse fetch(AfterShipClient client) throws Exception {
        if (id == null || id.isEmpty()) {
            throw new ApiException(ErrorEnum.BAD_REQUEST.name(), "Invalid request: `id` is invalid");
        }
        String path = String.format("/postmen/v3/pickups/%s", id);
        ...
        GetPickupResponse result = new GetPickupResponse();
